                ...
                <form onSubmit={this.handleFormSubmit}>
                    <div className="col-md-6">
                        <div className="col-md-12 form-group">
                            <input
                            type="text" placeholder="name" className="form-control" onChange={this.handleNameChange} />
                        </div>
                        <div className="col-md-12 form-group">
                            <input
                            type="text" placeholder="street" className="form-control"
                        ...
                        <div className="col-md-12 form-group">
                            <input type="text" placeholder="payment" className="form-control"
